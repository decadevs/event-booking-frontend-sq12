        ...
        <div className={LoginCSS.loginFormPage}>
          <div className={LoginCSS.loginFormDetails}>
            ...
            <div className={LoginCSS.loginButton} >
              ...
              <button className={LoginCSS.googleBtn} style={{width: "300px"}}>
                    <img
                    src={Vector}
                    alt= 'google icon'
                    height = '20'
              ...
              <div className={LoginCSS.notReg}>Not yet registered?
              {/* <div className={LoginCSS.createLogin}>
                <Link to={""}>Create account</Link>
              </div> */}
              <Link className={LoginCSS.createLogin} to={""}> Create account</Link>
                </div>
