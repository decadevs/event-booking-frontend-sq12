  ...
  return (
    <main>
      ...
      <TopBar/>
        ...
        <Button onClick={handleClick} variant='contained' style={{backgroundColor: 'orangered', height:'50px', marginTop:'40px', marginBottom:'40px', width:'180px', fontSize:'12px'}}> Load More Events </Button>
